...
CREATE TABLE goal (
	...
	goal_time TIMESTAMP NOT NULL UNIQUE
);
...
CREATE TABLE match (
	...
	goal_goal_id INTEGER NOT NULL CONSTRAINT match_goal_id_fk REFERENCES goal,
	PRIMARY KEY (division_name, team1_name, team2_name, goal_goal_id)
);
